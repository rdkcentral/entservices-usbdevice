...
############################
# Build entservices-usbdevice
echo "buliding entservices-usbdevice"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-usbdevice \
-DUSE_THUNDER_R4=ON \
...
-include ${GITHUB_WORKSPACE}/entservices-testframework/Tests/mocks/libusb/libusb_compat.h \
...
cmake --build build/entservices-usbdevice --target install
echo "======================================================================================"
exit 0
